...
LICENSE 
----------------------------------------------- 
The onTap framework and the Fusebox Importer plugin 
...
Plugin Manager tool to install the Fusebox Importer plugin 
by navigating to http://[ontap]/admin/plugins and 
selecting the New Plugins tab. Locate the Fusebox Importer 
...
The root /fusebox/ directory in the zip archive should 
be directly underneath the plugin source directory, i.e. 
[ontap]/_tap/admin/plugins/source/fusebox 
