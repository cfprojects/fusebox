<cfcomponent output="false" extends="cfc.plugin">
	<cfscript>
		setValue("name","Fusebox Importer"); 
		...
		setValue("description","Imports and executes Fusebox applications within the context of your onTap application."); 
